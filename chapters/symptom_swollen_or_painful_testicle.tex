...
\begin{itemize}
  \item Emergency evaluation for acute severe pain: assess the cremasteric reflex and testicular lie, but do not use a reassuring Prehn sign to exclude torsion.
...
\begin{itemize}
  \item Testicular torsion: immediate surgical exploration and bilateral orchidopexy; a trained clinician may attempt manual detorsion while arranging surgery, but it must never delay operative treatment.
...
\begin{itemize}
  \item Sudden or significant testicular pain should be assessed urgently rather than treated at home. Do not delay care to try an analgesic.
