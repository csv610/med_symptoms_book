...
\begin{itemize}
  ...
  \item \textbf{NSAIDs:} Non-selective (ibuprofen, naproxen, aspirin) and COX-2 selective inhibit prostaglandin synthesis, reducing mucosal blood flow and bicarbonate secretion
...
\end{itemize}
\textbf{Note:} Classic symptom patterns (duodenal ulcer pain 2--5 hours after meals, gastric ulcer pain immediately after eating) are unreliable for distinguishing ulcer location and may be absent in up to 40\% of patients.
