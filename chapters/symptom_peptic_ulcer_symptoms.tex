...
\begin{itemize}
  \item EGD is used when indicated to visualize an ulcer, obtain biopsies when appropriate, assess bleeding or obstruction, test for \textit{H. pylori}, and exclude malignancy; some uncomplicated patients are evaluated initially with noninvasive testing and treatment pathways.
...
\bibitem{peptic_ulcer_symptoms:uptodate-peptic-ulcer} Lanas A, et al. Peptic ulcer disease: clinical features and diagnosis. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{peptic_ulcer_symptoms:nejm-ulcer} Lanas A, et al. ``Peptic Ulcer Disease.'' \emph{N Engl J Med}. 2023;389(18):1708-1718.
\bibitem{peptic_ulcer_symptoms:bmj-ulcer} Sostres C, et al. ``Peptic ulcer.'' \emph{BMJ}. 2024;385:e079876.
\bibitem{peptic_ulcer_symptoms:cochrane-ulcer-hpylori} Ford AC, et al. ``Helicobacter pylori eradication for peptic ulcer.'' \emph{Cochrane Database Syst Rev}. 2023;(6):CD013997.
\bibitem{peptic_ulcer_symptoms:harrison-peptic-ulcer} Longo DL, et al. \emph{Harrison\'s Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 325: Peptic Ulcer Disease.
\bibitem{peptic_ulcer_symptoms:gut-ulcer} Chan FKL, et al. ``NSAID-induced peptic ulcer.'' \emph{Gut}. 2024;73(2):289-301.
\end{thebibliography}
