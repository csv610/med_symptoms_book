...
\section*{Definition}
Polydipsia is an excessive sensation of thirst or fluid intake. There is no single daily volume that diagnoses it because needs vary with climate, activity, diet, and illness.
...
\begin{itemize}
  ...
  \item Specialist-supervised testing of urine and serum osmolality, sometimes including a water-deprivation or copeptin-based test, if diabetes insipidus is suspected.
  \item MRI brain if central diabetes insipidus or hypothalamic lesion suspected.
\end{itemize}

\section*{Treatment Options}
\begin{itemize}
  \item Treat the underlying cause; desmopressin is used for selected central diabetes insipidus, while hypercalcemia and other causes require specific treatment.
  \item Fluid intake is adjusted under clinical guidance; unsupervised restriction can cause dangerous dehydration or hypernatremia.
