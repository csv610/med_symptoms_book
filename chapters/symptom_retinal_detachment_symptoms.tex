...
\end{itemize}
\textbf{Note:} Central vision is salvageable if the macula remains attached at time of repair; prognosis declines sharply if the macula is detached for more than 72 hours.
...
\begin{itemize}
  ...
  \item Shield the unaffected eye to protect it from injury (especially in monocular patients)
