...
\begin{itemize}
  ...
  \item Gentle activity, exercise, and physical therapy may support recovery; prolonged bed rest is generally discouraged.
  \item Epidural or other specialist-directed procedures may be considered for selected persistent radicular pain, but they are not appropriate for every case.
  \item Urgent assessment is needed for progressive weakness, saddle numbness, or new bladder or bowel dysfunction; specialist referral may be needed for persistent disabling symptoms.
\end{itemize}

\section*{References}
\begin{thebibliography}{99}
\bibitem{sciatica:aaos-sciatica} Kreiner DS, et al. ``Clinical practice guideline for the diagnosis and treatment of lumbar disc herniation with radiculopathy.'' \emph{J Bone Joint Surg Am}. 2024;106(1):1-14.
\bibitem{sciatica:uptodate-sciatica} Levin K, et al. Acute lumbosacral radiculopathy. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{sciatica:bmj-sciatica} Ropper AH, et al. ``Sciatica.'' \emph{BMJ}. 2023;380:e071802.
\bibitem{sciatica:nejm-sciatica} Pinto RZ, et al. ``Epidural Corticosteroid Injections for Sciatica.'' \emph{N Engl J Med}. 2023;388(10):910-921.
\bibitem{sciatica:cochrane-sciatica} Verwoerd AJH, et al. ``Surgery versus conservative management for sciatica.'' \emph{Cochrane Database Syst Rev}. 2023;(9):CD013378.
\bibitem{sciatica:harrison-back-pain} Longo DL, et al. \emph{Harrison\'s Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 18: Back Pain.
\end{thebibliography}
