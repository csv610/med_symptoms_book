...
\begin{itemize}
  ...
  \item Electrolyte abnormalities are uncommon causes and should be investigated when other findings suggest them
...
\begin{itemize}
  ...
  \item Blood tests are guided by the history and examination rather than routinely checking electrolytes.
...
\bibitem{eye_twitching:defazio2017}
