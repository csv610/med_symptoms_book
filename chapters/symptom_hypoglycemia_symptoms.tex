...
\begin{itemize}
  ...
  \item Fasting or post-prandial hypoglycemia in non-diabetic patients
...
\end{itemize}
\textbf{Note:} Recurrent hypoglycemia can lead to hypoglycemia-associated autonomic failure (HAAF), where the glucose threshold for autonomic activation shifts to lower levels, diminishing or eliminating warning symptoms.
