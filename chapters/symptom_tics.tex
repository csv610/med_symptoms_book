...
\end{itemize}
\textbf{Important:} Coprolalia (involuntary swearing) occurs in only 10--15\% of Tourette syndrome people despite popular perception; the premonitory urge preceding tics distinguishes them from other hyperkinetic movement disorders.

\section*{Self-Care / Home Management}
\begin{itemize}
  \item Educate you, family, and teachers about the involuntary nature of tics to reduce stigma and punishment.
...
\bibitem{tics:uptodate-tics} Jankovic J, et al. Tic disorders: clinical features and management. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{tics:nejm-tics} Robertson MM, et al. ``Tourette Syndrome and Tic Disorders.'' \emph{N Engl J Med}. 2023;389(12):1122-1132.
\bibitem{tics:bmj-tics} Singer HS, et al. ``Tic disorders.'' \emph{BMJ}. 2024;385:e079321.
\bibitem{tics:cochrane-tics} Pringsheim T, et al. ``Pharmacological treatment for tic disorders.'' \emph{Cochrane Database Syst Rev}. 2023;(7):CD013576.
\bibitem{tics:harrison-tics} Jameson JL, et al. \emph{Harrison\'s Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 418: Tourette Syndrome.
\end{thebibliography}
