...
\end{itemize}
\textbf{Note:} Scotomas are often unnoticed by the patient until formally tested (visual completion phenomenon); patients with significant field loss may still read 20/20 on the Snellen chart.
