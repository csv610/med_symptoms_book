...
\section*{Definition}
Ear barotrauma is injury caused by failure to equalize pressure across the eardrum when ambient pressure changes. Middle-ear symptoms are particularly common during aircraft descent or diving descent, although injury can occur during ascent.
...
\end{itemize}
\textbf{Important:} Scuba divers with inner ear barotrauma require immediate ENT evaluation and may need surgical exploration for perilymph fistula; flying should be avoided until symptoms resolve.
...
\begin{itemize}
  \item Mild barotrauma: Observation, pain relief, and clinician-advised gentle equalization; many cases resolve without specific treatment
  \item Middle-ear fluid: Observation and follow-up are often appropriate; decongestants and systemic corticosteroids are not routinely effective
...
\begin{itemize}
  ...
  \item Ask a clinician or pharmacist whether a decongestant is safe before flying; these medicines are not suitable for everyone and evidence of benefit is limited
  ...
  \item Do not self-treat post-dive vertigo with sedatives; urgent assessment is needed for significant vertigo or hearing loss
\end{itemize}

\section*{References}
\begin{thebibliography}{99}
\bibitem{ear_barotrauma:ref1} Mirza S, Richardson H. ``Otic Barotrauma.'' BMJ. 2005;330(7499):1071--1072.
\bibitem{ear_barotrauma:ref2} Rosenfeld RM, Schwartz SR, Pynnonen MA, et al. ``Clinical Practice Guideline: Tympanostomy Tubes in Children.'' Otolaryngol Head Neck Surg. 2013;149(1 Suppl):S1--S35.
\bibitem{ear_barotrauma:ref3} Brown TP. ``Middle Ear Barotrauma from Scuba Diving.'' J La State Med Soc. 1995;147(5):217--220.
\bibitem{ear_barotrauma:ref4} Becker GD, Parell GJ. ``Barotrauma of the Ears and Sinuses after Scuba Diving.'' Eur Arch Otorhinolaryngol. 2001;258(4):159--163.
\bibitem{ear_barotrauma:ref5} Uzun C. ``Paranasal Sinus Barotrauma.'' In: Papadopoulos A, ed. Diving Medicine. Springer; 2020.
\end{thebibliography}
