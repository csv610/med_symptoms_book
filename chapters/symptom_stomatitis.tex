...
\section*{Definition}
Stomatitis is a broad term for inflammation of the oral mucosa, including the buccal surfaces, lips, palate, tongue, and floor of mouth, presenting as erythema, edema, ulceration, or vesicle formation with associated pain.

\section*{Pathophysiology}
Direct cytotoxicity (chemotherapy, radiation), immune-mediated epithelial destruction (aphthous, autoimmune), or infectious invasion (viral, fungal, bacterial) disrupts the mucosal barrier integrity. The resulting inflammation recruits neutrophils and lymphocytes, producing pain, edema, and functional impairment of eating and speaking.

\section*{Etiology}
\begin{itemize}
  \item \textbf{Aphthous stomatitis (canker sores):} Idiopathic minor, major, or herpetiform ulcers; associated with stress, trauma, and food sensitivities
  ...
  \item \textbf{Autoimmune:} Pemphigus vulgaris, oral lichen planus, erythema multiforme, lupus erythematosus
...
\begin{itemize}
  ...
  \item Rapidly progressive ulceration or tissue necrosis
\end{itemize}

\section*{Related Symptoms}
\begin{itemize}
  \item Oral mucosal erythema, erosions, or ulcerations
  \item Odynophagia (painful swallowing) and dysphagia
  \item Sialorrhea (drooling) or xerostomia
  \item Halitosis and dysgeusia
  \item Fever and cervical lymphadenopathy (if infectious)
\end{itemize}
\textbf{Note:} Chemotherapy-induced mucositis affects up to 40\% of patients receiving standard-dose chemotherapy and nearly all patients receiving head and neck radiation; it is a dose-limiting toxicity and a risk factor for sepsis.
