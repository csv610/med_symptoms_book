...
\bibitem{loss_of_smell:harrison-anosmia} Longo DL, et al. \emph{Harrison's Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 35: Olfactory Disorders.
\bibitem{loss_of_smell:uptodate-anosmia} Doty RL, et al. Evaluation and treatment of anosmia. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{loss_of_smell:desir} Desir J, et al. Olfactory dysfunction: a clinical review. \emph{JAMA}. 2023;329(7):565-577.
\bibitem{loss_of_smell:whitcroft} Whitcroft KL, et al. Olfactory dysfunction: a practical approach. \emph{BMJ}. 2024;385:e078142.
\bibitem{loss_of_smell:hummel} Hummel T, et al. Olfactory training: clinical practice update. \emph{Rhinology}. 2023;61(2):98-112.
\bibitem{loss_of_smell:doty-book} Doty RL. \emph{The Neurobiology of Olfaction}. 2nd ed. Cambridge University Press; 2024. Chapter 10: Clinical Olfactory Disorders.
\end{thebibliography}
