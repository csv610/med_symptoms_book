...
\end{itemize}
\textbf{Note:} Septic arthritis can coexist with gout; joint aspiration for Gram stain, culture, and crystal analysis is mandatory when infection is suspected.
