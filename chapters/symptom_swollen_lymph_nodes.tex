...
\begin{itemize}
  ...
  \item Overlying erythema, warmth, fluctuance suggesting suppurative lymphadenitis
\end{itemize}
...
\begin{itemize}
  ...
  \item Pruritus
\end{itemize}
\textbf{Note:} Imaging (ultrasound, CT) and biopsy (excisional preferred over FNA for lymphoma diagnosis) guided by node characteristics, location, and clinical context.
