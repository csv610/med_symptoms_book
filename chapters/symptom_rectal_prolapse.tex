...
\end{itemize}
\textbf{Note:} Rectal prolapse should be distinguished from mucosal prolapse and hemorrhoidal disease; full-thickness prolapse shows concentric mucosal rings, while hemorrhoids show radial groove pattern.
...
\begin{itemize}
  ...
  \item Surgical repair for symptomatic full-thickness prolapse: perineal approach (Altemeier perineal proctosigmoidectomy, Delorme mucosectomy) for older or high-risk patients
  \item Abdominal approach (laparoscopic ventral rectopexy, sacral colpopexy) for younger patients with better tissue quality
  \item Thiersch wire or anal encirclement procedure rarely used; reserved for the frailest patients
