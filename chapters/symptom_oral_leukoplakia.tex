...
\end{itemize}
\textbf{Note:} Erythroleukoplakia (speckled leukoplakia) has a much higher malignant transformation risk (up to 25\%) than homogeneous leukoplakia and must be biopsied urgently.
...
\begin{itemize}
  ...
  \item Annual surveillance for all patients with a history of leukoplakia
\end{itemize}
