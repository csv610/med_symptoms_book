\chapter{Intestinal Obstruction}
...
\begin{itemize}
  ...
  \item CT abdomen/pelvis is commonly used to identify the obstruction, cause, and complications such as ischemia or perforation; IV contrast is selected when appropriate, while oral contrast is not required in every suspected obstruction
...
\bibitem{intestinal_obstruction_symptoms:harrison-bowel-obstruction} Longo DL, et al. \emph{Harrison's Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 363: Intestinal Obstruction.
\bibitem{intestinal_obstruction_symptoms:uptodate-sbo} Zielinski MD, et al. Management of small bowel obstruction. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{intestinal_obstruction_symptoms:maung} Maung AA, et al. Small bowel obstruction: a clinical review. \emph{JAMA}. 2023;329(11):921-933.
\bibitem{intestinal_obstruction_symptoms:catena} Catena F, et al. World Society of Emergency Surgery guidelines on intestinal obstruction. \emph{World J Emerg Surg}. 2024;19(1):15.
\bibitem{intestinal_obstruction_symptoms:tenbroek} ten Broek RPG, et al. Adhesive small bowel obstruction: an updated review. \emph{Lancet Gastroenterol Hepatol}. 2023;8(4):356-367.
\bibitem{intestinal_obstruction_symptoms:taylor} Taylor MR, et al. \emph{Sabiston Textbook of Surgery}. 21st ed. Elsevier; 2023. Chapter 48: Intestinal Obstruction.
\end{thebibliography}
