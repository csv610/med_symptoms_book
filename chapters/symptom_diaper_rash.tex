...
\end{itemize}
\textbf{Important:} Candida diaper dermatitis classically spares the skin folds, whereas irritant dermatitis involves the convex surfaces of the buttocks and thighs.

\section*{Medical Evaluation}
\begin{itemize}
  \item Clinical diagnosis by inspection of diaper area distribution and morphology
  \item Testing is usually unnecessary; a KOH preparation or culture may be considered when candidiasis or bacterial infection is suspected and the diagnosis is uncertain or treatment fails
\end{itemize}
...
\begin{itemize}
  \item Change diapers promptly after soiling and use a generous barrier ointment; diaper-free time may help
  \item Cleanse gently with warm water or fragrance-free, alcohol-free wipes; avoid scrubbing and irritants
  \item Apply barrier ointment (zinc oxide 40\%, petrolatum) at each change
\end{itemize}

\section*{References}
\begin{thebibliography}{99}
\bibitem{diaper_rash:ref1} Scheinfeld N. ``Diaper Dermatitis.'' Am J Clin Dermatol. 2005;6(5):273--281.
\bibitem{diaper_rash:ref2} Visscher MO. ``Recent Advances in Diaper Dermatitis.'' Pediatr Dermatol. 2021;38(Suppl 2):26--34.
\bibitem{diaper_rash:ref3} Friedlander SF, Eichenfield LF, Leyden JJ, et al. ``Diaper Dermatitis: A Review and Update.'' J Am Acad Dermatol. 2005;53(4):607--618.
\bibitem{diaper_rash:ref4} Kliegman RM, St Geme JW III, Blum NJ, et al. ``Nelson Textbook of Pediatrics.'' 22nd ed. Elsevier; 2024.
\bibitem{diaper_rash:ref5} Weston WL, Lane AT, Morelli JG. ``Color Textbook of Pediatric Dermatology.'' 4th ed. Mosby; 2007.
\end{thebibliography}
