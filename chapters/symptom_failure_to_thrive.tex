...
\begin{itemize}
  ...
  \item Laboratory tests are guided by the history and examination; routine broad panels are not required for every child
\end{itemize}
...
\begin{itemize}
  ...
  \item Regular follow-up with individualized weight and development monitoring
\end{itemize}
...
\bibitem{failure_to_thrive:ref1} Kliegman RM, St Geme JW III, Blum NJ, et al. ``Nelson Textbook of Pediatrics.'' 22nd ed. Elsevier; 2024.
\bibitem{failure_to_thrive:ref2} Cole SZ, Lanham JS. ``Failure to Thrive: An Update.'' Am Fam Physician. 2011;83(7):829--834.
\bibitem{failure_to_thrive:ref3} Gahagan S. ``Failure to Thrive: A Consequence of Undernutrition.'' Pediatr Rev. 2006;27(1):e1--e11.
\bibitem{failure_to_thrive:ref4} Perrin EC, Cole CH, Frank DA, et al. ``Criteria for Determining Disability in Infants and Children: Failure to Thrive.'' Pediatrics. 2003;111(1):177--184.
\bibitem{failure_to_thrive:ref5} Wright CM. ``Identification and Management of Failure to Thrive.'' Arch Dis Child. 2000;83(1):78--81.
\end{thebibliography}
