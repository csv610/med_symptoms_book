...
\begin{itemize}
  ...
  \item Imaging is not routinely needed for typical croup; it may be considered when the diagnosis is uncertain and should not delay airway care
...
\begin{itemize}
  \item Dexamethasone is used according to severity and local protocol: mild-to-moderate croup may be treated with a lower dose, while severe or life-threatening croup commonly receives 0.6 mg/kg (maximum dose varies by protocol); a clinician should select the dose and route
...
\begin{itemize}
  ...
  \item A cool-mist humidifier may be soothing, but evidence is limited; avoid hot steam because of burn risk
  \item Acetaminophen or ibuprofen for fever and discomfort
  \item Hydration with clear liquids in small, frequent amounts
  \item Keep the child comfortable and upright while awake; do not use unsafe sleep positioning or leave a distressed child unattended
\end{itemize}

\section*{References}
\begin{thebibliography}{99}
\bibitem{croup:ref1} Cherry JD. ``Clinical Practice: Croup.'' N Engl J Med. 2008;358(4):384--391.
\bibitem{croup:ref2} Petrocheilou A, Tanou K, Kalampouka E, et al. ``Viral Croup: Diagnosis and a Treatment Algorithm.'' Pediatr Pulmonol. 2014;49(5):421--429.
\bibitem{croup:ref3} Bjornson CL, Johnson DW. ``Croup.'' Lancet. 2008;371(9609):329--339.
\bibitem{croup:ref4} Kliegman RM, St Geme JW III, Blum NJ, et al. ``Nelson Textbook of Pediatrics.'' 22nd ed. Elsevier; 2024.
\bibitem{croup:ref5} Johnson DW, Williamson J. ``Croup: A Clinical Review.'' Pediatr Rev. 2018;39(9):451--463.
\end{thebibliography}
