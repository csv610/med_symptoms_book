...
\begin{itemize}
  ...
  \item Image-guided diagnostic SI-joint injection may support the diagnosis when a compatible history and examination are present, but no single test is a universal gold standard
