...
\begin{itemize}
  \item Immediate cooling: cold-water immersion when safe, evaporative cooling, mist and fan, or ice packs to the neck, axillae, and groin; emergency clinicians select additional methods based on the cause and severity.
...
\bibitem{hyperthermia:harrison-hypertherm} Longo DL, et al. \emph{Harrison's Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 476: Hyperthermia and Hypothermia.
\bibitem{hyperthermia:uptodate-hypertherm} Bouchama A, et al. Heat stroke and hyperthermia. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{hyperthermia:bouchama} Bouchama A, et al. Heat stroke: a clinical review. \emph{N Engl J Med}. 2022;386(21):2001-2012.
\bibitem{hyperthermia:cialdini} Cialdini K, et al. Malignant hyperthermia: diagnosis and management. \emph{Anesth Analg}. 2023;136(5):876-889.
\bibitem{hyperthermia:rosen} Walls RM, et al. \emph{Rosen's Emergency Medicine: Concepts and Clinical Practice}. 10th ed. Elsevier; 2023. Chapter 135: Heat-Related Illness.
\bibitem{hyperthermia:lefeber} Lefeber EJ, et al. Neuroleptic malignant syndrome: a clinical update. \emph{Am J Psychiatry}. 2023;180(6):424-435.
\end{thebibliography}
