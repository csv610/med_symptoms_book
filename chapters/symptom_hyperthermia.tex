...
\end{itemize}
\textbf{Note:} Heat stroke mortality ranges from 10--65\% and is directly correlated with the duration and degree of temperature elevation; immediate whole-body cooling is the priority before any laboratory or imaging evaluation.
