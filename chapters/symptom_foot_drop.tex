...
\section*{Definition}
Foot drop is the inability to dorsiflex the ankle, resulting in a steppage gait where the patient lifts the knee higher to clear the foot during the swing phase of gait. It is caused by weakness of the tibialis anterior muscle and may be due to upper motor neuron, lower motor neuron, or peripheral nerve pathology.
...
\end{itemize}
\textbf{Note:} Acute foot drop with severe low back pain and urinary retention is cauda equina syndrome, a surgical emergency requiring immediate spinal imaging.
