...
\end{itemize}
\textbf{Note:} Costochondritis is a diagnosis of exclusion; cardiac ischemia must always be considered first in patients with cardiac risk factors, regardless of chest wall tenderness.
...
\begin{itemize}
  ...
  \item ECG and cardiac biomarkers to exclude acute coronary syndrome in at-risk patients
...
\begin{itemize}
  ...
  \item Acetaminophen or topical analgesic creams for patients with NSAID contraindications
