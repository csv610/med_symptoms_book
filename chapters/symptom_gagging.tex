...
\begin{itemize}
  \item Treat the identified cause; acid suppression, infection treatment, or psychological therapy is used only when indicated
  \item Desensitization therapy for exaggerated or conditioned gag reflex (graded exposure)
  \item Behavioral or desensitization therapy may help a conditioned gag reflex; evidence for complementary approaches is limited
