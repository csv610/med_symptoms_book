...
\section*{Definition}
Apraxia is difficulty performing learned, purposeful movements despite adequate strength, sensation, coordination, comprehension, and effort. It is caused by impaired planning or sequencing of a skilled action and may affect limb gestures, tool use, walking, or speech. It is an acquired neurologic sign rather than a disease by itself.
...
Apraxia results from dysfunction in distributed networks that represent, plan, sequence, and monitor skilled actions. Dominant parietal, frontal, callosal, and subcortical pathways may be involved, but the location and pattern vary by apraxia type and cause. A person may know what they want to do but be unable to organize the movement correctly.
...
\begin{itemize}
 ...
 \item Neurodegenerative disease: Corticobasal degeneration (asymmetric apraxia is a hallmark), Alzheimer's disease (ideational apraxia may emerge in moderate stages), progressive supranuclear palsy, dementia with Lewy bodies
...
\begin{itemize}
 ...
 \item Neuroimaging, often urgent CT for suspected stroke or bleeding and MRI when more detail is needed, to identify structural lesions or atrophy patterns.
...
\begin{itemize}
 \item Stroke or brain-injury rehabilitation with occupational, physical, and speech-language therapy as appropriate, focusing on meaningful tasks, cueing, gesture practice, and safe sequencing. Constraint-induced therapy is not appropriate for everyone.
 ...
 \item Medicines treat the underlying condition or associated symptoms; no medication reliably reverses apraxia itself.
...
\begin{itemize}
 ...
 \item Slow down and focus on one step at a time; occupational therapy can teach adaptive strategies and assess safety.
\end{itemize}
...
\bibitem{apraxia:ref6} American Heart Association/American Stroke Association. Guidelines for adult stroke rehabilitation and recovery. Updated 2026.
\bibitem{apraxia:ref7} MedlinePlus. Apraxia. Updated 2023.
\end{thebibliography}
