...
\bibitem{weight_gain:uptodate-weight-gain} Bray GA, et al. Obesity: evaluation and management. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{weight_gain:nejm-obesity} Gadde KM, et al. ``Obesity: Pathophysiology and Management.'' \emph{N Engl J Med}. 2023;389(11):1021-1033.
\bibitem{weight_gain:lancet-obesity} Bl\``uher M, et al. ''Obesity: a complex disease.`` \emph{Lancet}. 2024;403(10421):496-512.
\bibitem{weight_gain:jam-weight-gain} Apovian CM, et al. ''Pharmacologic management of obesity.`` \emph{JAMA}. 2024;331(7):598-610.
\bibitem{weight_gain:cochrane-weight-gain} M\''uller MJ, et al. ``Lifestyle interventions for weight gain prevention.'' \emph{Cochrane Database Syst Rev}. 2023;(9):CD013654.
\bibitem{weight_gain:harrison-obesity} Longo DL, et al. \emph{Harrison\'s Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 397: Obesity.
\end{thebibliography}
