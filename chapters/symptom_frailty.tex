...
\end{itemize}
\textbf{Important:} Frailty can improve with targeted interventions. Screening is guided by age, function, clinical setting, and local recommendations rather than a universal age cutoff.

\section*{Medical Evaluation}
\begin{itemize}
  \item Screen with FRAIL scale, Fried phenotype, or Clinical Frailty Scale
  \item Assess gait speed, grip strength, and sit-to-stand performance using the criteria appropriate to the chosen screening tool
...
\begin{itemize}
  ...
  \item Seek individualized nutrition advice, including protein and vitamin D assessment when appropriate
