...
\begin{itemize}
  ...
  \item Substance-induced: Stimulants (cocaine, amphetamines, methamphetamine, MDMA), Dopaminergic agonists (levodopa, pramipexole, ropinirole), Corticosteroids (especially at high doses), Anabolic-androgenic steroids, Antidepressant-induced (SSRIs, bupropion in bipolar patients), Alcohol (intoxication or withdrawal), Hallucinogens (PCP, LSD), Cannabis (particularly high-THC strains)
...
\begin{itemize}
  ...
  \item Any suspicion of mania in a patient taking antidepressants (possible unmasking of bipolar disorder)
...
\begin{itemize}
  ...
  \item Catatonia
\end{itemize}
\textbf{Note:} Hypomania may be ego-syntonic and perceived positively by the patient, leading to treatment non-adherence; collateral history from family is essential for accurate diagnosis.
