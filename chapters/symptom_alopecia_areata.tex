...
\end{itemize}
\textbf{Note:} The exclamation point hair (broken, tapering hairs) at the margin of active patches is pathognomonic on dermatoscopy and indicates active disease.
