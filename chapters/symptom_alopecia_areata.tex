...
\section*{Causes}
\begin{itemize}
 \item \textbf{Genetic:} HLA class II alleles (DRB1\textit{04, DQB1}03), ULBP3, and other loci; 10--20\% have family history
...
\end{itemize}
\textbf{Important:} Exclamation-point hairs and other trichoscopic findings can support active alopecia areata, but they are not individually diagnostic and should be interpreted with the clinical examination.
...
\bibitem{alopecia_areata:ref1} Strazzulla LC, Wang EHC, et al. ``Alopecia areata: disease characteristics, clinical evaluation, and new perspectives on pathogenesis.'' \textit{J Am Acad Dermatol}. 2018;78(1):1-12.
\bibitem{alopecia_areata:ref2} King BA, Senna MM, et al. ``Baricitinib for the treatment of alopecia areata.'' \textit{J Am Acad Dermatol}. 2022;87(5):993-1001.
\bibitem{alopecia_areata:ref3} Messenger AG, McKillop J, et al. ``British Association of Dermatologists guidelines for the management of alopecia areata.'' \textit{Br J Dermatol}. 2012;166(5):916-926.
\bibitem{alopecia_areata:ref4} James WD, Elston DM, et al. \textit{Andrews\' Diseases of the Skin: Clinical Dermatology}, 13th ed. Elsevier, 2019.
