...
\begin{itemize}
  ...
  \item Cough
\end{itemize}
\textbf{Note:} Night sweats with unexplained weight loss and fever constitute red flags for lymphoma or tuberculosis. Investigations include CBC, ESR/CRP, thyroid function, HIV test, chest radiograph.
