...
\section*{Definition}
Pain scratchiness irritation in throat worsened swallowing talking.

\section*{Pathophysiology}
Most commonly bacterial causes require different treatment approach post-nasal drip vocal strain acidic reflux smoking dry air contributing factors.
...
\begin{itemize}
  ...
  \item Symptoms lasting more than 1-2 weeks normally resolve persistent evaluate for strep cancer thyroid mass
...
\end{itemize}
\textbf{Note:} Always consider serious underlying conditions when evaluating persistent sore throat.
