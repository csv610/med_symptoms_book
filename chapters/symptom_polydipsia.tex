...
\end{itemize}
\textbf{Important:} Distinguishing diabetes insipidus from primary polydipsia requires specialist-supervised testing. Depending on availability and the clinical context, this may include copeptin-based testing or a carefully monitored water-deprivation test; neither should be attempted at home.
