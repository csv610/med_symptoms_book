...
\end{itemize}
\textbf{Note:} The water deprivation test remains the gold standard for distinguishing diabetes insipidus from primary polydipsia, though it must be performed under close supervision.
