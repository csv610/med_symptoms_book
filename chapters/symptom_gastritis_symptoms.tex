...
\begin{itemize}
  \item EGD with biopsy may be used when alarm features, persistent symptoms, bleeding, or another indication is present; uncomplicated dyspepsia is not diagnosed by routine biopsy in every patient.
...
\begin{itemize}
  \item Acid suppression may be prescribed for selected acid-related disease; the medicine, dose, and duration depend on the cause and individual risks
