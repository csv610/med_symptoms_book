...
\end{itemize}
\textbf{Note:} Symptomatic adult-acquired flatfoot is most commonly due to posterior tibial tendon dysfunction and should be staged radiographically to guide management.
