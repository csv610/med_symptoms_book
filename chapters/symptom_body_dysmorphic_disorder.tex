...
\begin{itemize}
  ...
  \item \textbf{Genetic:} Family studies suggest heritability; elevated rates in first-degree relatives of BDD patients
...
\end{itemize}
\textbf{Note:} Many individuals with BDD seek cosmetic or dermatologic treatment rather than psychiatric care, which rarely improves the preoccupation.
