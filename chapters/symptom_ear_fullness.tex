...
\begin{itemize}
  \item \textbf{Eustachian-tube dysfunction:} treat contributing nasal disease when present and use gentle pressure-equalization measures only if advised; procedures are reserved for selected persistent cases
  \item \textbf{Cerumen impaction:} Cerumenolytic drops (carbamide peroxide) or microsuction removal
  \item Suspected Meniere disease requires specialist assessment; dietary advice and medicines are individualized, while intratympanic treatment is reserved for selected cases
...
\begin{itemize}
  ...
  \item Saline nasal care may help nasal symptoms; ask a clinician or pharmacist before using decongestants or antihistamines
  \item If advised to equalize pressure, use gentle swallowing or yawning; stop if painful and do not force a Valsalva maneuver
  \item TMJ stretching exercises if jaw tenderness present
  \item Avoid suspected personal triggers and follow specialist advice if Meniere disease is diagnosed
  \item Warm compress over the ear for muscle tension-related fullness
\end{itemize}

\section*{References}
\begin{thebibliography}{99}
\bibitem{ear_fullness:ref1} Rosenfeld RM, Schwartz SR, Cannon CR, et al. ``Clinical Practice Guideline: Acute Otitis Externa.'' Otolaryngol Head Neck Surg. 2014;150(1 Suppl):S1--S24.
\bibitem{ear_fullness:ref2} Seikel JA, King DW, Drumright DG. ``Anatomy \& Physiology for Speech, Language, and Hearing.'' 5th ed. Cengage; 2015.
\bibitem{ear_fullness:ref3} Pasha R, Golub JS. ``Otolaryngology: A Clinical and Surgical Reference.'' 2nd ed. Thieme; 2024.
\bibitem{ear_fullness:ref4} Krouse JH, Stachler RJ, Haddad J Jr. ``Ear Fullness and Pressure.'' In: Otolaryngology--Head and Neck Surgery. 5th ed. Lippincott Williams \& Wilkins; 2020.
\bibitem{ear_fullness:ref5} Tunkel DE, Bauer CA, Sun GH, et al. ``Clinical Practice Guideline: Tinnitus.'' Otolaryngol Head Neck Surg. 2014;151(2 Suppl):S1--S40.
\end{thebibliography}
