...
\section*{Definition}
Tonsillitis is inflammation of the palatine tonsils, typically of infectious origin, diagnosed clinically by sore throat, erythematous and swollen tonsils, with or without exudate. The Centor criteria (fever, tonsillar exudate, tender cervical lymphadenopathy, absence of cough) stratify likelihood of group A streptococcal infection.

\section*{Pathophysiology}
Infectious pathogens (most commonly viruses or group A \textit{Streptococcus}) breach the tonsillar crypt epithelium, triggering a local inflammatory cascade with neutrophil infiltration, vasodilation, and edema. The immune response within tonsillar lymphoid tissue produces exudate and systemic symptoms through cytokine release.
...
\begin{itemize}
  ...
  \item Unilateral tonsillar swelling with uvular deviation suggesting peritonsillar abscess
  \item Suspicion of airway compromise or stridor
  \item History of rheumatic fever or recurrent tonsillitis (more than 6 episodes/year)
\end{itemize}

\section*{Related Symptoms}
\begin{itemize}
  \item Sore throat, odynophagia, cervical lymphadenopathy, fever, halitosis, referred otalgia
\end{itemize}
\textbf{Note:} Viral tonsillitis typically presents with cough, rhinorrhea, and hoarseness, whereas bacterial tonsillitis more often presents with high fever and exudate.
...
\begin{itemize}
  ...
  \item Corticosteroids (single dose of dexamethasone 0.6 mg/kg) for severe pain or airway edema
  ...
  \item Drainage and antibiotics for peritonsillar abscess; airway monitoring if compromised
\end{itemize}
