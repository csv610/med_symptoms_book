...
\begin{itemize}
  \item Treatment depends on the pattern and cause and may include observation, topical or injected corticosteroid treatment for selected inflammatory alopecias, or other specialist-directed therapy.
  \item Minoxidil may help some forms of hair loss; other medicines or procedures are considered only after the diagnosis is established.
...
\bibitem{hair_loss:harrison-hair} Longo DL, et al. \emph{Harrison's Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 64: Alopecia.
\bibitem{hair_loss:uptodate-hair} Price VH, et al. Evaluation and diagnosis of hair loss. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{hair_loss:trueb} Trueb RM. Systematic approach to hair loss in women. \emph{J Dtsch Dermatol Ges}. 2023;21(4):368-382.
\bibitem{hair_loss:kang} Kang JS, et al. Androgenetic alopecia: an update. \emph{J Am Acad Dermatol}. 2023;89(1):S1-S8.
\bibitem{hair_loss:olsen} Olsen EA, et al. \emph{Disorders of Hair Growth: Diagnosis and Treatment}. 4th ed. McGraw-Hill; 2023.
\bibitem{hair_loss:messenger} Messenger AG, et al. Alopecia areata: a clinical review. \emph{Br J Dermatol}. 2024;190(2):175-187.
\end{thebibliography}
