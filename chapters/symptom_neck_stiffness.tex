...
\section*{Definition}
Neck stiffness is reduced or painful neck movement. It may result from muscle strain, but acute stiffness with fever, headache, altered consciousness, or neurologic signs can indicate meningitis or subarachnoid hemorrhage.
...
\section*{Causes}
\begin{itemize}
  \item Muscle strain, cervical arthritis, migraine, meningitis, encephalitis, subarachnoid hemorrhage, cervical spine injury, and inflammatory disease.
...
Emergency care is required for fever, severe headache, confusion, light sensitivity, vomiting, rash, seizure, weakness, recent trauma, or rapidly worsening stiffness. Do not delay emergency assessment while attempting home treatment.
...
\bibitem{symptom_neck_stiffness:ref1} Jameson JL, et al. \textit{Harrison's Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022.
\bibitem{symptom_neck_stiffness:ref2} American Heart Association and relevant specialty societies. Current emergency evaluation and management guidance; accessed 2025.
\bibitem{symptom_neck_stiffness:ref3} National Institute for Health and Care Excellence. Relevant clinical guidance. NICE; accessed 2025.
\end{thebibliography}
