...
Reactivation of latent herpes simplex virus type 1 within the vestibular ganglion (Scarpa ganglion) causes inflammation and swelling of the superior vestibular nerve. This produces a sudden asymmetry in tonic vestibular signals between the two sides, generating a false sense of rotation.
...
\begin{itemize}
  ...
  \item Distinguish from central causes: normal neurologic exam (no slurred speech, dysmetria, or weakness)
\end{itemize}
...
\end{itemize}
\textbf{Important:} The absence of hearing loss and tinnitus distinguishes vestibular neuritis from labyrinthitis; the absence of neurologic signs distinguishes it from central vertigo (brainstem or cerebellar stroke).
...
\begin{itemize}
  ...
  \item \textbf{Prognosis:} Most people recover within weeks; persistent imbalance and motion sensitivity may require ongoing VRT
\end{itemize}

\section*{References}
\begin{thebibliography}{99}
\bibitem{vestibular_neuritis:ref1} Strupp M, Brandt T. ``Vestibular neuritis.'' \textit{Neurology}, 2009;72(18):1588--1594.
\bibitem{vestibular_neuritis:ref2} Baloh RW. ``Vestibular neuritis.'' \textit{New England Journal of Medicine}, 2003;348(11):1027--1032.
\bibitem{vestibular_neuritis:ref3} Strupp M, Dieterich M, Brandt T. ``Pharmacotherapy of vestibular disorders.'' \textit{Current Opinion in Neurology}, 2018;31(1):100--107.
\bibitem{vestibular_neuritis:ref4} Halmagyi GM, Curthoys IS. ``A clinical sign of canal paresis.'' \textit{Archives of Neurology}, 1988;45(7):737--739. [Head impulse test]
\bibitem{vestibular_neuritis:ref5} Fife TD, Iverson DJ, Lempert T, et al. ``Practice parameter: Therapies for benign paroxysmal positional vertigo (an evidence-based review).'' \textit{Neurology}, 2008;70(22):2067--2074.
\bibitem{vestibular_neuritis:ref6} Chawla N, Olshaker JS. ``Diagnosis and management of acute vestibular neuritis.'' \textit{Journal of Emergency Medicine}, 2021;60(5):634--642.
\end{thebibliography}
