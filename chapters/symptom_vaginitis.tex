...
\begin{itemize}
  ...
  \item \textbf{Trichomoniasis:} Trichomonas vaginalis (sexually transmitted); green-yellow, frothy discharge; itching and dysuria; elevated pH >5; motile organisms on wet mount
  \item \textbf{Atrophic vaginitis:} Estrogen deficiency (postmenopausal, breastfeeding, postpartum); thin, inflamed mucosa; dyspareunia; dry or watery discharge
...
\begin{itemize}
  \item Abnormal vaginal discharge, itching, vulvar irritation, dysuria, dyspareunia, odor, vaginal erythema, vaginal dryness
\end{itemize}
\textbf{Note:} Bacterial vaginosis is the most common cause of vaginitis in reproductive-age women, affecting 15--50\% depending on the population.
