...
Testicular pain can be caused by inflammation (epididymitis, orchitis), torsion (twisting of the spermatic cord causing ischemia), trauma, tumors, or varicocele (dilated veins). Torsion cuts off blood supply, causing ischemia and infarction within 4-6 hours. Referred pain can occur from kidney stones, hernia, or prostatitis via shared nerve pathways.
...
\item Urinary symptoms (frequency, urgency, dysuria)
\end{itemize}
