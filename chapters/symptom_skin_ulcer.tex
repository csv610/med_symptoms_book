...
\section*{Definition}
A skin ulcer is a full-thickness defect of the epidermis and dermis that fails to progress through the normal healing sequence, persisting for more than 2 weeks. Chronic ulcers are classified by etiology: venous, arterial, neuropathic (diabetic), or pressure-related.

\section*{Pathophysiology}
Chronic ulceration results from impaired tissue perfusion, persistent inflammation, and dysregulated wound healing. Venous ulcers arise from ambulatory venous hypertension causing fibrin cuff deposition and leukocyte trapping. Arterial ulcers reflect critical limb ischemia from atherosclerotic occlusion. Neuropathic ulcers in diabetes involve sensory loss, motor deformity, and autonomic dysfunction leading to repetitive trauma and unperceived injury. Pressure ulcers develop from sustained mechanical loading causing ischemia--reperfusion injury.
...
Seek care if:
\begin{itemize}
  \item New ulcer in a patient without clear etiology or with atypical features
...
\end{itemize}
\textbf{Note:} Wound assessment must include vascular evaluation (ABI, Doppler waveforms) before compression therapy, as applying compression to an arterial ulcer can worsen ischemia and cause limb loss.
...
\begin{itemize}
  \item Determine etiology: history (pain pattern, claudication, edema, diabetes), location, wound bed appearance, and surrounding skin
...
\begin{itemize}
  \item Venous: Compression therapy (multi-layer, 30--40 mmHg), leg elevation, pentoxifylline, wound debridement
  \item Arterial: Revascularization (angioplasty, bypass), risk factor modification, antiplatelet therapy
  \item Diabetic/neuropathic: Offloading (total contact cast, CAM walker), sharp debridement, infection control, glycemic optimization
