...
\begin{itemize}
  ...
  \item Anoscopy can directly visualize internal hemorrhoids and is commonly used when inspection and digital examination are insufficient; the typical positions are variable and should not be treated as a diagnostic requirement
...
\bibitem{hemorrhoids:harrison-hemorrh} Longo DL, et al. \emph{Harrison's Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 348: Hemorrhoids.
\bibitem{hemorrhoids:uptodate-hemorrh} Steele SR, et al. Hemorrhoids: clinical features and evaluation. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{hemorrhoids:ascrs} Davis BR, et al. American Society of Colon and Rectal Surgeons practice parameters for the management of hemorrhoids. \emph{Dis Colon Rectum}. 2023;66(7):860-873.
\bibitem{hemorrhoids:glenn} Glenn JA, et al. Hemorrhoidal disease: a comprehensive review. \emph{JAMA}. 2022;327(15):1478-1489.
\bibitem{hemorrhoids:gordon} Gordon PH, et al. \emph{Principles and Practice of Surgery for the Colon, Rectum, and Anus}. 5th ed. CRC Press; 2023. Chapter 10: Hemorrhoids.
\bibitem{hemorrhoids:kaidar} Kaidar-Person O, et al. Hemorrhoids: a review of treatment options. \emph{Surg Clin North Am}. 2023;103(2):331-345.
\end{thebibliography}
