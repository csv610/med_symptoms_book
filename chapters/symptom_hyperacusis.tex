...
\end{itemize}
\textbf{Note:} Hyperacusis distinct from phonophobia (a migraine symptom) in that the discomfort is loudness-based rather than specifically fear-based; both can co-occur.
