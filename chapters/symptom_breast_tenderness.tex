...
\begin{itemize}
 ...
 \item Imaging is not routinely needed for diffuse or cyclical pain without other suspicious findings. For focal, persistent, noncyclical pain, imaging is selected by age and pregnancy or lactation status; ultrasound is usually appropriate under age 30, and diagnostic mammography or tomosynthesis with or without ultrasound may be appropriate from age 30.
...
\begin{itemize}
 \item Cyclical mastalgia is managed with a supportive bra, a symptom diary, and topical or oral pain relievers when safe. Reducing caffeine or dietary salt helps some people but is not consistently effective.
 ...
 \item Evening primrose oil, vitamin E, and other supplements have not shown consistent benefit and should not replace assessment or evidence-based treatment.
...
\begin{itemize}
 ...
 \item Consider topical or oral pain relief only as directed on the label and only if safe for you; ask a clinician or pharmacist before using NSAIDs, especially during pregnancy, with ulcers, kidney disease, blood thinners, or other interacting medicines.
\end{itemize}

\section*{References}
\begin{thebibliography}{99}
\bibitem{breast_tenderness:ref1} Salzman B, Collins E, et al. ``Common breast problems.'' \textit{Am Fam Physician}. 2019;99(7):446-453.
\bibitem{breast_tenderness:ref2} Smith RL, Pruthi S, et al. ``Evaluation and management of breast pain.'' \textit{Mayo Clin Proc}. 2004;79(3):353-358.
\bibitem{breast_tenderness:ref3} Rosolowich V, Satin N, et al. ``Mastalgia: a review.'' \textit{J Obstet Gynaecol Can}. 2006;28(1):49-57.
\bibitem{breast_tenderness:ref4} Harris JR, Lippman ME, et al. \textit{Diseases of the Breast}, 5th ed. Wolters Kluwer, 2014.
\bibitem{breast_tenderness:ref5} UpToDate. ``Breast pain: evaluation and management.'' Wolters Kluwer, 2023.
\end{thebibliography}
