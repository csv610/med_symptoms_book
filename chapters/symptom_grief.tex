...
\begin{itemize}
  ...
  \item Substance use
\end{itemize}
\textbf{Note:} Grief is not a mental disorder per se; the key distinction from major depression is that grief features intense yearning and episodic waves of pain while preserving the capacity for positive emotions and pleasure.
