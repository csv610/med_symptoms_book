...
\begin{itemize}
\item Conservative care may include warm soaks, appropriately placed cotton under the nail edge, and footwear changes; antibiotics are not routine without infection
...
\bibitem{ingrown_toenails:uptodate-ingrown} Eekhof JAH, et al. Ingrown toenail. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{ingrown_toenails:coughlin} Coughlin MJ, et al. \emph{Mann's Surgery of the Foot and Ankle}. 10th ed. Elsevier; 2023. Chapter 29: Ingrown Toenails.
\bibitem{ingrown_toenails:heidelbaugh} Heidelbaugh JJ, et al. Management of ingrown toenails. \emph{Am Fam Physician}. 2023;107(3):275-283.
\bibitem{ingrown_toenails:declerck} Declerck G, et al. Ingrown toenails: a systematic review of treatment. \emph{J Foot Ankle Surg}. 2024;63(1):98-107.
\bibitem{ingrown_toenails:ekhof} Eekhof JAH, et al. Conservative versus surgical treatment of ingrown toenails. \emph{Br J Gen Pract}. 2022;72(721):380-386.
\bibitem{ingrown_toenails:rozeboom} Rozeboom AM, et al. Phenol matrixectomy for ingrown toenail. \emph{Dermatol Surg}. 2023;49(6):567-574.
\end{thebibliography}
