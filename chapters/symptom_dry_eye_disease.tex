...
\begin{itemize}
  ...
  \item Evidence for omega-3 supplements is inconsistent; discuss supplements with a clinician, especially if you take anticoagulants.
\end{itemize}

\section*{Self-Care and Home Management}
\begin{itemize}
  \item Use lubricating artificial tears as directed; preservative-free products are useful when drops are needed frequently or preservatives irritate the eyes.
  \item Apply a comfortably warm, not hot, compress to the eyelids and practise gentle lid hygiene if recommended.
