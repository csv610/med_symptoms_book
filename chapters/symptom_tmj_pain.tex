...
\begin{itemize}
  ...
  \item \textbf{Infectious:} Septic TMJ arthritis (rare), odontogenic abscess, parotitis
...
\end{itemize}
\textbf{Note:} TMJ pain can mimic otalgia (earache); a normal otoscopic examination should prompt TMJ evaluation in patients with ear pain.
...
\begin{itemize}
  ...
  \item MRI for disc position, morphology, and joint effusion
