...
\end{itemize}
\textbf{Important:} The ABCDEF mnemonic for subungual melanoma:\\[2pt] A (age $>$60, African/Asian/Hispanic), B (brown/black band), C (change), D (digit $>$3\,mm), E (extension), F (family history).
...
\begin{itemize}
  \item Confirmed fungal disease may be treated with a topical or oral antifungal selected by a clinician; oral terbinafine requires assessment for interactions and liver risk.
  ...
  \item Yellow nail syndrome requires treatment of associated lymphatic or respiratory disease; supplements and injections are specialist decisions.
\end{itemize}
