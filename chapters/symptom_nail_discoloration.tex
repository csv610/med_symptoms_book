...
\end{itemize}
\textbf{Note:} The ABCDEF mnemonic for subungual melanoma: A (age >60, African/Asian/Hispanic), B (brown/black band), C (change), D (digit involved >3 mm), E (extension), F (family history).
