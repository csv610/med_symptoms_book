...
\item Targeted liver, kidney, thyroid, and hormone testing guided by the history and examination
\item hCG and tumor markers if testicular tumor suspected
\item Breast imaging when the examination is atypical or malignancy is suspected
\item Testicular ultrasound if exam is abnormal
\end{itemize}

\section*{Treatment Options}
\begin{itemize}
\item Review potentially causative medicines with the prescriber; do not stop essential treatment independently
\item Treat underlying cause (hypogonadism, hyperthyroidism)
\item Selective estrogen receptor modulators (tamoxifen)
\item Other hormone-modifying medicines are specialist decisions and are not routine treatment
...
\item Do not stop prescribed medicines without discussing alternatives with the prescriber
...
\bibitem{gynecomastia:harrison-gyneco} Longo DL, et al. \emph{Harrison's Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 409: Gynecomastia.
\bibitem{gynecomastia:uptodate-gyneco} Swerdloff RS, et al. Gynecomastia in adults. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{gynecomastia:bhatt} Bhatt VR, et al. Gynecomastia: a systematic review. \emph{Am J Med}. 2022;135(4):455-463.
\bibitem{gynecomastia:braunstein} Braunstein GD. Clinical practice: gynecomastia. \emph{N Engl J Med}. 2020;383(18):1765-1773.
\bibitem{gynecomastia:williams-shlomo} Melmed S, et al. \emph{Williams Textbook of Endocrinology}. 15th ed. Elsevier; 2023. Chapter 20: Gynecomastia.
\bibitem{gynecomastia:bowen} Bowen DJ, et al. Evaluation and management of gynecomastia. \emph{JAMA}. 2023;329(6):491-499.
\end{thebibliography}
