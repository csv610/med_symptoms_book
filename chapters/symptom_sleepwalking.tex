...
\section*{Etiology}
\begin{itemize}
  \item \textbf{Primary:} Idiopathic -- most common in children and often resolves spontaneously
...
\end{itemize}
\textbf{Note:} Waking a sleepwalker is not dangerous (it does not cause a heart attack) but may lead to confusion or agitation; gentle guidance back to bed is preferred.
