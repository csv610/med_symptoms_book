...
\begin{itemize}
  \item New or severe wheezing with difficulty breathing requires urgent assessment rather than over-the-counter cough treatment.
  \item If asthma or COPD is already diagnosed, use the prescribed reliever and action plan; do not use another person’s inhaler.
  \item Treatment depends on the cause, which may include airway medicines, treatment of infection or allergy, or removal of an inhaled foreign body.
\end{itemize}
