...
\begin{itemize}
  ...
  \item \textbf{Necrotizing (malignant) otitis externa:} Pseudomonas osteomyelitis of the temporal bone in diabetics and immunocompromised patients
\end{itemize}
...
\end{itemize}
\textbf{Note:} The pathognomonic sign of otitis externa is severe pain with traction on the pinna or pressure on the tragus, which is absent in uncomplicated acute otitis media.
