...
\end{itemize}
\textbf{Note:} Acute rigidity with hyperthermia and altered mental status after neuroleptic exposure is neuroleptic malignant syndrome and requires emergency treatment.
...
\begin{itemize}
  ...
  \item Anticholinergics (benztropine) for rigidity in younger patients
