...
\section{Definition}
Sunburn is acute cutaneous inflammation caused by excessive exposure to ultraviolet (UV) radiation from the sun or artificial sources (tanning beds). It is characterized by erythema, pain, and in severe cases, blistering.

\section{Pathophysiology}
UV-B radiation (290-320 nm) damages DNA in keratinocytes, causing the formation of pyrimidine dimers. Damaged cells release inflammatory mediators (prostaglandins, histamine, cytokines), causing vasodilation (erythema), pain, and edema. Apoptosis of damaged keratinocytes leads to peeling 3-7 days after exposure. UV-A radiation (320-400 nm) penetrates deeper, contributing to photoaging and immunosuppression.
...
\item Photoaging (wrinkles, hyperpigmentation)
...
\item Tetanus prophylaxis if large area of blistering
\end{itemize}
