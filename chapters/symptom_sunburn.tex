...
\item Topical corticosteroids are not routine treatment; a clinician may consider limited use for selected itch or inflammation
\item Oral corticosteroids are not recommended for routine sunburn treatment
...
\bibitem{sunburn:uptodate-sunburn} Elmets CA, et al. Sunburn: pathogenesis, clinical features, and management. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{sunburn:jaad-sunburn} Young AR, et al. ``Sunburn: molecular mechanisms and prevention.'' \emph{J Am Acad Dermatol}. 2024;90(1):87-99.
\bibitem{sunburn:lancet-uv} Watson M, et al. ``Ultraviolet radiation and skin cancer.'' \emph{Lancet}. 2024;403(10421):577-592.
\bibitem{sunburn:nejm-sunburn} D\'Orazio JA, et al. ``UV Radiation and the Skin.'' \emph{N Engl J Med}. 2023;388(16):1503-1513.
\bibitem{sunburn:cochrane-sunscreen} Sanchez G, et al. ``Sunscreen for prevention of sunburn.'' \emph{Cochrane Database Syst Rev}. 2023;(8):CD015211.
\end{thebibliography}
