...
\end{itemize}
\textbf{Note:} Atypical pneumonia (\textit{Mycoplasma}, \textit{Chlamydia}, \textit{Legionella}) often presents with headache, myalgias, and dry cough with minimal chest findings, earning the historical name "walking pneumonia."
...
\begin{itemize}
  ...
  \item Sputum Gram stain and culture for hospitalized patients; molecular panel (PCR) for atypical pathogens
