...
The underlying mechanism involves localized desquamation of the filiform papillae from the dorsal tongue surface, likely mediated by T-lymphocyte infiltration and cytokine release at the epithelial level. The migratory nature reflects cycles of inflammation, healing, and recurrence in different areas.
...
\begin{itemize}
  ...
  \item New or changing oral lesions in a patient > 40 years old (exclude malignancy)
...
\begin{itemize}
  ...
  \item Fissured tongue (scrotal tongue) in up to 50\% of patients
...
\end{itemize}
\textbf{Note:} Geographic tongue affects 1--3\% of the population, is entirely benign, and requires no treatment in asymptomatic patients; the key differential includes oral candidiasis, lichen planus, and erythematous candidiasis.
...
\begin{itemize}
  ...
  \item Avoidance of triggers identified by the patient
\end{itemize}
