...
\end{itemize}
\textbf{Note:} Hypersomnia must be distinguished from simple fatigue or lack of motivation, as the management of primary hypersomnia disorders differs substantially from secondary causes.
...
\begin{itemize}
  ...
  \item Brain MRI with pituitary protocol if central hypersomnia of unclear etiology
\end{itemize}
