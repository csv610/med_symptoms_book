...
\begin{itemize}
  ...
  \item Tests for Lyme disease or other infections are ordered only when exposure, examination, or symptoms support those diagnoses.
...
\begin{itemize}
  ...
  \item Follow facial-rehabilitation advice from a clinician; forceful exercises can be unhelpful during acute weakness.
...
\bibitem{facial_droop:jauch2008}
