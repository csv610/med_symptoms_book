...
\begin{itemize}
  ...
  \item Symptoms lasting more than Evaluate if new, irregular, or accompanied by chest pain/dizziness/syncope
...
\end{itemize}
\textbf{Note:} Always consider serious underlying conditions when evaluating persistent palpitations.
