...
\end{itemize}
\textbf{Note:} The direction and gaze-dependence of nystagmus provide critical localizing value -- downbeat nystagmus suggests craniocervical junction pathology (Chiari), while direction-changing gaze-evoked nystagmus implies cerebellar or brainstem integrator dysfunction.
...
\begin{itemize}
  ...
  \item Central nystagmus: Treat underlying etiology (thiamine for Wernicke, immunosuppression for MS, surgical decompression for Chiari, stroke management).
