...
\begin{itemize}
  ...
  \item If you have a known heart-valve condition, ask your cardiologist or dentist whether antibiotic prophylaxis is appropriate; it is reserved for selected highest-risk patients and certain dental procedures, not routine surgery or all valve abnormalities.
\end{itemize}

\section*{References}

\begin{thebibliography}{99}
\bibitem{heart_murmur:harrison-cardio} Longo DL, et al. \emph{Harrison's Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 236: Approach to the Patient with a Heart Murmur.
\bibitem{heart_murmur:uptodate-murmur} Bonow RO, et al. Auscultation of heart murmurs in adults. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{heart_murmur:otto} Otto CM, et al. \emph{Valvular Heart Disease: A Companion to Braunwald's Heart Disease}. 6th ed. Elsevier; 2023. Chapter 3: Physical Examination.
\bibitem{heart_murmur:bailey} Bailey SN, et al. Evaluation of heart murmurs in primary care. \emph{Am Fam Physician}. 2023;107(4):372-381.
\bibitem{heart_murmur:bonow2021} Bonow RO, et al. 2020 ACC/AHA guideline for the management of valvular heart disease. \emph{Circulation}. 2021;143(5):e72-e227.
\bibitem{heart_murmur:braunwald} Libby P, et al. \emph{Braunwald's Heart Disease}. 12th ed. Elsevier; 2022. Chapter 14: Heart Murmurs and Valvular Disease.
\end{thebibliography}
