...
\begin{itemize}
  ...
  \item Brain imaging is selected according to the onset and examination; emergency CT or MRI may be used when stroke or bleeding is suspected.
  \item EMG, nerve-conduction studies, antibody tests, genetic testing, or other investigations are used only when the history and examination suggest a specific cause.
\end{itemize}

\section*{Treatment Options}
\begin{itemize}
  \item Treat the underlying cause; emergency stroke treatment, Parkinson disease medicines, immune treatment, or other therapies are selected by specialists according to the diagnosis and timing.
...
\bibitem{dysarthria:ref1} Duffy JR. ``Motor Speech Disorders: Substrates, Differential Diagnosis, and Management.'' 4th ed. Elsevier; 2020.
\bibitem{dysarthria:ref2} Darley FL, Aronson AE, Brown JR. ``Motor Speech Disorders.'' W.B. Saunders; 1975.
\bibitem{dysarthria:ref3} Yorkston KM, Beukelman DR, Strand EA, et al. ``Management of Motor Speech Disorders in Children and Adults.'' 3rd ed. Pro-Ed; 2010.
\bibitem{dysarthria:ref4} Spencer KA, Brown KA. ``Dysarthria.'' In: Gonzalez-Fernandez M, ed. Neurogenic Communication Disorders. Springer; 2020.
\bibitem{dysarthria:ref5} Mackenzie C. ``Dysarthria in Progressive Neurological Disease.'' J Neurol Neurosurg Psychiatry. 2011;82(9):949--957.
\end{thebibliography}
