...
\begin{itemize}
  ...
  \item Catheter-directed thrombus removal is reserved for selected extensive, limb-threatening, or severe iliofemoral DVT cases
  \item An inferior vena cava filter is considered mainly when acute VTE is present and anticoagulation is contraindicated, or in selected cases despite treatment
  \item Compression stockings are not routinely required for everyone to prevent post-thrombotic syndrome; they may help selected patients with persistent symptoms
\end{itemize}
...
\begin{itemize}
  ...
  \item Use compression garments only if recommended and fitted appropriately by a clinician
  \item Strictly adhere to anticoagulation regimen; do not skip doses
\end{itemize}

\section*{References}
\begin{thebibliography}{99}
\bibitem{deep_vein_thrombosis_symptoms:pe1} Konstantinides SV, Meyer G, Becattini C, et al. ``2019 ESC guidelines for the diagnosis and management of acute pulmonary embolism.'' Eur Heart J. 2020;41(4):543-603.
\bibitem{deep_vein_thrombosis_symptoms:pe2} Di Nisio M, van Es N, Buller HR. ``Deep vein thrombosis and pulmonary embolism.'' Lancet. 2016;388(10063):3060-3073.
\bibitem{deep_vein_thrombosis_symptoms:pe3} Thompson BT, Kabrhel C. ``Overview of acute pulmonary embolism in adults.'' UpToDate, 2023.
\bibitem{deep_vein_thrombosis_symptoms:pe4} Kearon C, Akl EA, Ornelas J, et al. ``Antithrombotic therapy for VTE disease: CHEST guideline.'' Chest. 2016;149(2):315-352.
\bibitem{deep_vein_thrombosis_symptoms:pe5} Wells PS, Anderson DR, Rodger M, et al. ``Derivation of a simple clinical model to categorize patients probability of pulmonary embolism.'' Thromb Haemost. 2000;83(3):416-420.
\bibitem{deep_vein_thrombosis_symptoms:pe6} Becattini C, Agnelli G. ``Acute pulmonary embolism.'' In: Harrison\'s Principles of Internal Medicine. 21st ed. McGraw-Hill; 2022.
\end{thebibliography}
