...
\begin{itemize}
  ...
  \item Tachypnea
\end{itemize}
\textbf{Important:} Persistent fever warrants systematic investigation including blood cultures, CBC with differential, inflammatory markers (ESR, CRP), urinalysis, chest imaging, and consideration of autoimmune/neoplastic etiologies when initial workup negative.
