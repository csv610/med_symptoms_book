...
Hypotension results from reduced cardiac output, decreased systemic vascular resistance, or a combination of both. The compensatory baroreceptor reflex increases heart rate, contractility, and peripheral vasoconstriction; hypotension ensues when these mechanisms are overwhelmed or impaired.
...
\begin{itemize}
  ...
  \item \textbf{Distributive:} Sepsis (most common cause in hospitalized patients), anaphylaxis, neurogenic shock (spinal cord injury), adrenal insufficiency
...
\end{itemize}
\textbf{Note:} Orthostatic hypotension is confirmed by a drop in systolic BP of at least 20 mmHg or diastolic BP of at least 10 mmHg within 3 minutes of standing from a supine position.
