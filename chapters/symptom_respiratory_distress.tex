...
\end{itemize}
\textbf{Note:} Grunting in an infant is a compensatory mechanism that generates intrinsic PEEP to maintain alveolar patency and should not be mistaken for comfort.

\section*{Self-Care / Home Management}
\begin{itemize}
  \item Sit the patient upright in a tripod position (leaning forward with arms supported on a table)
