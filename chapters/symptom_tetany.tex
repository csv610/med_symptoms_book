...
\begin{itemize}
  ...
  \item Laryngospasm causing stridor or difficulty breathing
...
\begin{itemize}
  ...
  \item Laryngospasm: stridor, hoarseness, respiratory distress
...
\end{itemize}
\textbf{Note:} Chvostek sign is present in 10--25\% of normal individuals; Trousseau sign is more specific (sensitivity 94\%) for latent tetany and should be preferentially used.
