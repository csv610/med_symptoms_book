...
\end{itemize}
\textbf{Note:} The stuck-on appearance and pseudohorn cysts on dermoscopy are highly characteristic of SK; however, pigmented SK may mimic melanoma and requires careful dermoscopic evaluation.
...
\begin{itemize}
  ...
  \item Skin biopsy for histopathology if diagnosis uncertain; features include acanthosis, papillomatosis, hyperkeratosis, pseudohorn cysts
\end{itemize}
