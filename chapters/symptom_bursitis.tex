...
\begin{itemize}
 ...
 \item No improvement after a short period of conservative care, or recurrent symptoms
...
\end{itemize}
\textbf{Important:} A hot, red, very tender bursa with fever or feeling unwell may be septic bursitis and needs prompt medical assessment. Aspiration and antibiotics are decided by a clinician; corticosteroid injection should be avoided until infection has been excluded.
...
\begin{itemize}
 ...
 \item Aspiration and bursal fluid analysis (cell count, Gram stain, culture, and crystal analysis) when infection, gout, or another diagnosis is suspected
...
\begin{itemize}
 ...
 \item Pain relief and anti-inflammatory treatment when safe, without assuming a fixed duration
 \item Intrabursal corticosteroid injection only for selected non-infectious cases after assessment
...
\begin{itemize}
 ...
 \item Consider an over-the-counter pain reliever only if safe for you and according to the label; ask a clinician or pharmacist before using NSAIDs
\end{itemize}
