...
\section*{Definition}
Pain anywhere between chest and groin; one of most common reasons for medical consultation.
...
\end{itemize}
\textbf{Note:} Always consider serious underlying conditions when evaluating persistent abdominal pain.
