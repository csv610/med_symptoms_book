...
\begin{itemize}
  ...
  \item Chest pain with swallowing or that awakens the patient from sleep
...
\end{itemize}
\textbf{Note:} Esophageal spasm can present identically to cardiac chest pain; all patients with undifferentiated chest pain should have ECG and cardiac biomarkers before esophageal evaluation.
