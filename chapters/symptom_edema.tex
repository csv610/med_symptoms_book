...
\item Treat the underlying cause; diuretics are used for selected systemic causes such as fluid-overloaded heart failure, kidney disease, or cirrhosis
\item Compression therapy may help venous or lymphatic edema only after arterial circulation and the cause have been assessed
\item Review contributing medicines with a clinician; do not stop prescribed treatment without advice
\item Leg elevation, movement, and skin care may help selected dependent or venous edema
\end{itemize}

\section*{Self-Care and Home Management}
\begin{itemize}
\item Elevate the legs above heart level several times daily
\item Follow individualized dietary advice; do not impose strict sodium or fluid restriction without a clinician's recommendation
\item Use compression stockings only after appropriate assessment and fitting
\item Avoid prolonged sitting or standing
\item Follow fluid advice appropriate to the cause; excess fluid can worsen some heart, kidney, or liver conditions
