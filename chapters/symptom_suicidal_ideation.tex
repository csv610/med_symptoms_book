...
\begin{itemize}
  ...
  \item New-onset or worsening suicidal ideation in a patient with known psychiatric illness
  \item Recent discharge from psychiatric hospitalization (highest risk period)
  \item Patient who expresses hopelessness, feeling trapped, being a burden, or having no reason to live
...
\end{itemize}
\textbf{Note:} Any expression of suicidal ideation warrants immediate clinical assessment; safety is the priority --- ask directly, ensure a safe environment, and never leave a suicidal patient alone.
