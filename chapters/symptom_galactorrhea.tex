...
Galactorrhea results from hyperprolactinemia, which disrupts the normal hypothalamic--pituitary inhibition of prolactin (tonic inhibition by dopamine from the tuberoinfundibular pathway). Excess prolactin stimulates lactotroph hyperplasia in the breast and milk production. However, galactorrhea can also occur with normal prolactin levels due to increased breast sensitivity to prolactin.
...
\begin{itemize}
  ...
  \item \textbf{Pituitary/hypothalamic:} Prolactinoma (micro- or macroadenoma), pituitary stalk compression, empty sella syndrome, craniopharyngioma
...
\begin{itemize}
  ...
  \item Pituitary MRI is considered when prolactin elevation persists or the history suggests a pituitary lesion, after excluding common causes
  \item Breast imaging (mammogram, ultrasound) if discharge is bloody, unilateral, or single-duct
\end{itemize}

\section*{Treatment Options}
\begin{itemize}
  \item Review potentially causative medicines with the prescriber; do not stop them independently
...
\bibitem{galactorrhea:melmed2011}
Melmed S, Casanueva FF, Hoffman AR, et al. Diagnosis and treatment of hyperprolactinemia. \textit{Endocr Rev}. 2011;32(2):265--306.
\bibitem{galactorrhea:wang2012}
Wang AT, Mullan RJ, Lane MA, et al. Treatment of hyperprolactinemia: a systematic review and meta-analysis. \textit{J Clin Endocrinol Metab}. 2012;97(5):1583--1592.
\bibitem{galactorrhea:glezer2008}
Glezer A, Bronstein MD. Prolactinomas. \textit{Endocrinol Metab Clin North Am}. 2008;37(1):67--86.
\bibitem{galactorrhea:speroff2011}
Speroff L, Fritz MA. Galactorrhea. In: \textit{Clinical Gynecologic Endocrinology and Infertility}. 8th ed. Lippincott Williams \& Wilkins; 2011.
\bibitem{galactorrhea:kleinberg1977}
Kleinberg DL, Noel GL, Frantz AG. Galactorrhea: a study of 235 cases. \textit{N Engl J Med}. 1977;296(11):589--600.
\bibitem{galactorrhea:pena2001}
Pe\~{n}a KS, Staudenmeier JJ. Galactorrhea. \textit{Am Fam Physician}. 2001;63(9):1775--1780.
\end{thebibliography}
