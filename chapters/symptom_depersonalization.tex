...
\begin{itemize}
  \item First-line: Psychoeducation and reassurance that the symptoms can occur with stress, while ensuring that neurological, substance-related, and other medical causes have been assessed when indicated
...
\bibitem{depersonalization:ref1} American Psychiatric Association. ``Depersonalization/derealization disorder.'' In: Diagnostic and Statistical Manual of Mental Disorders. 5th ed, Text Revision. APA; 2022.
\bibitem{depersonalization:ref2} Simeon D, Abugel J. ``Feeling Unreal: Depersonalization Disorder and the Loss of the Self.'' 2nd ed. Oxford University Press; 2023.
\bibitem{depersonalization:ref3} Sierra M, Berrios GE. ``Depersonalization: neurobiological perspectives.'' Biol Psychiatry. 1998;44(9):898-908.
\bibitem{depersonalization:ref4} Spiegel D, Loewenstein RJ, Lewis-Fernandez R, et al. ``Dissociative disorders in DSM-5.'' Depress Anxiety. 2011;28(12):E17-E29.
\bibitem{depersonalization:ref5} Hunter ECM, Charlton J, David AS. ``Depersonalisation and derealisation: assessment and management.'' BMJ. 2017;356:j745.
\bibitem{depersonalization:ref6} Sierra M. ``Depersonalization disorder: clinical features and diagnosis.'' UpToDate. Wolters Kluwer; 2025.
\end{thebibliography}
