...
\end{itemize}
\textbf{Important:} A 72-hour fecal-fat collection is cumbersome and is now used selectively. Fecal elastase-1 is commonly used as an initial test for pancreatic exocrine insufficiency, with interpretation affected by watery stool and the broader clinical context.
...
\bibitem{steatorrhea:ref1} DiMagno EP, Go VLW, Summerskill WHJ. ``Relations between pancreatic enzyme outputs and malabsorption in severe pancreatic insufficiency.'' \textit{New England Journal of Medicine}, 1973;288(16):813--815.
\bibitem{steatorrhea:ref2} Green PH, Cellier C. ``Celiac disease.'' \textit{New England Journal of Medicine}, 2007;357(17):1731--1743.
\bibitem{steatorrhea:ref3} Forsmark CE. ``Pancreatitis and pancreatic insufficiency.'' In: \textit{Harrison's Principles of Internal Medicine}, 21st ed. McGraw-Hill, 2022.
\bibitem{steatorrhea:ref4} Leeds JS, Hopper AD, Sidhu R, et al. ``Steatorrhea: An update on causes and management.'' \textit{European Journal of Gastroenterology \& Hepatology}, 2007;19(11):953--958.
\bibitem{steatorrhea:ref5} Lankisch PG, Mahlke R, Blum T, et al. ``Steatorrhea: You cannot trust your eyes when it comes to diagnosis.'' \textit{Pancreatology}, 2002;2(1):25--29.
\bibitem{steatorrhea:ref6} Ramakrishna BS. ``Tropical sprue.'' \textit{Journal of Gastroenterology and Hepatology}, 2011;26(Suppl 3):117--121.
\end{thebibliography}
