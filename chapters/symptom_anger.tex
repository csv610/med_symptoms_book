...
Perceived threat or frustration activates the amygdala, which signals the hypothalamus and periaqueductal gray, triggering the sympathetic nervous system (catecholamine release) and the brain's temperature control center--pituitary--adrenal axis (cortisol). Prefrontal cortex inhibitory control may be reduced by stress, sleep deprivation, or neurochemical imbalances (low serotonin, high norepinephrine), lowering the threshold for aggressive outbursts.
