...
Seek care if:
\begin{itemize}
  \item Acute onset of severe thigh pain with swelling, warmth, and erythema (rule out DVT or infection)
...
\begin{itemize}
  ...
  \item Swelling, ecchymosis, or palpable mass
...
\end{itemize}
\textbf{Note:} Acute anterior thigh pain with inability to bear weight after a sprinting injury suggests a quadriceps or rectus femoris rupture, often requiring surgical repair.
...
\begin{itemize}
  ...
  \item Ultrasound for DVT (Doppler), abscess, or muscle tear evaluation
...
\begin{itemize}
  ...
  \item Antibiotics and surgical debridement for pyomyositis or necrotizing fasciitis
  ...
  \item Pain management and surgical resection for bone tumors
\end{itemize}
