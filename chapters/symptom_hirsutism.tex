...
\begin{itemize}
  ...
  \item Galactorrhea
\end{itemize}
\textbf{Important:} PCOS is the most common cause of hirsutism and is diagnosed by the Rotterdam criteria requiring two of three: oligo-ovulation, clinical or biochemical hyperandrogenism, and polycystic ovaries on ultrasound, with exclusion of other etiologies.
...
\begin{itemize}
  \item For women not seeking pregnancy, combined oral contraceptives are commonly considered for bothersome hirsutism when appropriate.
  \item Anti-androgens such as spironolactone or finasteride may be added by a clinician after discussing contraception, pregnancy risks, monitoring, and adverse effects.
...
\bibitem{hirsutism:harrison-hirsut} Longo DL, et al. \emph{Harrison's Principles of Internal Medicine}. 21st ed. McGraw-Hill; 2022. Chapter 408: Hirsutism and Virilization.
\bibitem{hirsutism:uptodate-hirsut} Martin KA, et al. Evaluation and management of hirsutism in women. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{hirsutism:yildiz} Yildiz BO, et al. Hirsutism: diagnosis and treatment. \emph{Lancet Diabetes Endocrinol}. 2023;11(6):426-438.
\bibitem{hirsutism:goodman} Goodman NF, et al. AACE/ACE guidelines for the diagnosis and treatment of hirsutism. \emph{Endocr Pract}. 2023;29(8):601-617.
\bibitem{hirsutism:azeim} Azziz R, et al. \emph{Androgen Excess Disorders in Women}. 2nd ed. Springer; 2023. Chapter 12: Hirsutism.
\bibitem{hirsutism:spritzer} Spritzer PM, et al. Hirsutism: from pathophysiology to treatment. \emph{Rev Endocr Metab Disord}. 2023;24(2):267-282.
\end{thebibliography}
