...
\begin{itemize}
  ...
  \item Persistent papules or pustules may be treated with clinician-selected topical medicines or oral anti-inflammatory antibiotics; brimonidine and oxymetazoline are used mainly for persistent facial erythema.
...
\bibitem{rosacea:rosacea-consensus} Gallo RL, et al. ``Standard classification and pathophysiology of rosacea.'' \emph{J Am Acad Dermatol}. 2024;90(2):253-266.
\bibitem{rosacea:uptodate-rosacea} Powell FC, et al. Rosacea: pathogenesis, clinical features, and diagnosis. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{rosacea:jaad-rosacea-treatment} Thiboutot DM, et al. ``Rosacea treatment update.'' \emph{J Am Acad Dermatol}. 2024;90(3):494-506.
\bibitem{rosacea:nejm-rosacea} van Zuuren EJ, et al. ``Rosacea.'' \emph{N Engl J Med}. 2023;388(21):1976-1986.
\bibitem{rosacea:cochrane-rosacea} van Zuuren EJ, et al. ``Interventions for rosacea.'' \emph{Cochrane Database Syst Rev}. 2023;(4):CD003262.
\end{thebibliography}
