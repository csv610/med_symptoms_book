...
\begin{itemize}
   ...
   \item Seek medical assessment after a significant choking episode, even if the object is expelled, or if cough, wheeze, voice change, or breathing difficulty persists.
\end{itemize}
...
\begin{itemize}
  \item After an acute choking episode, your doctor will assess airway patency, oxygen saturation, and examine the oropharynx for residual foreign body or mucosal injury.
   \item Imaging is selected when a retained foreign body, aspiration, or injury is suspected; plain X-rays can miss radiolucent objects.
...
\begin{itemize}
   \item For a conscious adult or child with severe airway obstruction, call emergency services and alternate five back blows with five abdominal thrusts. For an infant, alternate five back blows with five chest thrusts; use chest thrusts for a person whose abdomen cannot be encircled.
