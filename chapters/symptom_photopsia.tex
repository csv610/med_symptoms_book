...
\begin{itemize}
  ...
  \item New-onset photopsia in an immunocompromised patient (suspect infectious retinitis)
\end{itemize}
...
\end{itemize}
\textbf{Note:} Acute photopsia with new floaters is a retinal tear until proven otherwise; urgent dilated fundus examination with scleral depression is mandatory.
