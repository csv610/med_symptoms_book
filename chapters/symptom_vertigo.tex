...
\begin{itemize}
  \item Canalith-repositioning manoeuvres are used for confirmed benign paroxysmal positional vertigo.
  \item Vestibular rehabilitation and treatment of the identified vestibular, neurological, infectious, or cardiovascular cause are preferred over prolonged suppressive medication.
  \item Sudden vertigo with weakness, speech difficulty, severe headache, or inability to walk requires emergency assessment for posterior-circulation stroke.
\end{itemize}
