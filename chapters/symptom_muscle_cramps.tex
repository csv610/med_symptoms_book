...
\begin{itemize}
  ...
  \item Symptoms lasting more than persistent beyond relief frequent recurrence unexplained absence trauma requires medical evaluation
...
\end{itemize}
\textbf{Note:} Always consider serious underlying conditions when evaluating persistent muscle cramps.
