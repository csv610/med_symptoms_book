...
\begin{itemize}
  ...
  \item Tendon swelling with palpable defect or ecchymosis (suspect rupture)
...
\begin{itemize}
  ...
  \item Swelling, warmth, and erythema in acute tendonitis
  \item Weakness of the associated muscle group
\end{itemize}
\textbf{Note:} Tendon rupture, particularly of the Achilles, biceps, or rotator cuff, presents with a sudden pop, weakness, and a palpable gap; surgical evaluation is urgent.
...
\begin{itemize}
  ...
  \item Surgical debridement and repair for complete rupture or failed non-operative management
\end{itemize}
