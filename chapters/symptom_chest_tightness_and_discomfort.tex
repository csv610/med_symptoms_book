...
\begin{itemize}
   \item Asthma or COPD treatment is individualized and may include inhaled bronchodilators and inhaled corticosteroid-containing therapy; follow the prescribed plan.
   \item Treatment for suspected or confirmed coronary disease depends on the diagnosis and urgency. Antiplatelet therapy, anti-anginal medicines, or revascularization are not interchangeable and require clinician assessment.
...
\begin{itemize}
  \item If chest tightness is sudden, severe, or accompanied by shortness of breath, radiating pain, sweating, or nausea, call emergency services immediately.
   \item For known asthma or COPD, use the reliever inhaler and action plan prescribed for you; do not rely on a color-based inhaler label.
