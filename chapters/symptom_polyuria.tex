...
\section*{Causes}
\begin{itemize}
  \item Water diuresis: Central diabetes insipidus (ADH deficiency from pituitary/brain's temperature control center lesions, head trauma, surgery), Nephrogenic diabetes insipidus (lithium toxicity, hypercalcemia, hypokalemia, inherited mutations, chronic kidney disease), Primary polydipsia (psychogenic, dipsogenic)
