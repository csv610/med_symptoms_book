...
\begin{itemize}
  ...
  \item Dizziness
\end{itemize}
\textbf{Note:} A 24-hour urine collection with simultaneous serum and urine osmolality, followed by a water deprivation test or desmopressin challenge, distinguishes diabetes insipidus subtypes from primary polydipsia.
