...
\section*{Causes}
\begin{itemize}
  \item \textbf{Primary (idiopathic):} Most common; caused by incompetent or congenitally absent venous valves in the internal spermatic vein
...
\begin{itemize}
  ...
  \item For selected patients requiring intervention, options include microsurgical varicocelectomy, laparoscopic ligation, or percutaneous embolization; the choice depends on anatomy, symptoms, fertility goals, expertise, and recurrence risk.
...
\bibitem{varicocele:aua-varicocele} Sharlip ID, et al. ``AUA guideline for the management of varicocele.'' \emph{J Urol}. 2024;212(2):218-228.
\bibitem{varicocele:uptodate-varicocele} Wein AJ, et al. Varicocele: clinical features and evaluation. In: UpToDate, Post TW (Ed), UpToDate, Waltham, MA; 2025.
\bibitem{varicocele:nejm-varicocele} Schlegel PN, et al. ``Varicocele and Male Infertility.'' \emph{N Engl J Med}. 2023;389(14):1305-1315.
\bibitem{varicocele:bmj-varicocele} Clavijo RI, et al. ``Varicocele in adults.'' \emph{BMJ}. 2024;386:e081543.
\bibitem{varicocele:cochrane-varicocele} Kroese ACJ, et al. ``Varicocele repair for male infertility.'' \emph{Cochrane Database Syst Rev}. 2023;(6):CD014838.
\end{thebibliography}
