...
Shock results from failure of the circulatory system to deliver sufficient oxygen and nutrients to meet tissue demands. Hypovolemic shock: loss of circulating volume (hemorrhage, dehydration). Cardiogenic shock: pump failure (myocardial infarction, arrhythmia). Distributive shock: severe vasodilation (serious infection response, anaphylaxis, neurogenic). Obstructive shock: mechanical blockage to flow (pulmonary embolism, cardiac tamponade).
