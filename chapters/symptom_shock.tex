...
Shock results from failure of the circulatory system to deliver sufficient oxygen and nutrients to meet tissue demands. Hypovolemic shock results from loss of circulating volume (hemorrhage, dehydration). Cardiogenic shock results from pump failure (myocardial infarction, arrhythmia). Distributive shock results from severe vasodilation (sepsis, anaphylaxis, neurogenic causes). Obstructive shock results from mechanical blockage of flow (pulmonary embolism, cardiac tamponade).
...
\item Distributive: sepsis, anaphylaxis, spinal cord injury
...
\item Hypotension
\item Cardiac arrest
\item Sepsis or another serious infection
\item Anaphylaxis
\item Hemorrhage
\item Dehydration
\item Trauma
...
\item Lay the person flat if tolerated; do not elevate the legs when this worsens breathing, causes pain, or spinal, pelvic, or leg injury is suspected.
...
\item Treat the underlying cause: antibiotics for sepsis, anticoagulation or reperfusion for selected pulmonary emboli, and pericardiocentesis for tamponade
