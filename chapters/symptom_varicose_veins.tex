...
Venous hypertension from incompetent valves, venous wall weakness, or outflow obstruction leads to venous reflux and pooling. Chronic venous hypertension causes capillary leakage of fibrinogen, hemosiderin deposition, and activation of inflammatory mediators that produce skin changes, edema, and ulceration.

\section*{Etiology}
\begin{itemize}
  \item \textbf{Primary (idiopathic):} Familial predisposition (most common), female sex, hormonal factors (pregnancy, estrogen), prolonged standing
  \item \textbf{Secondary:} Post-thrombotic syndrome (secondary to DVT), pelvic vein obstruction, arteriovenous fistulas, obesity, advanced age
...
\begin{itemize}
  ...
  \item Skin changes: hyperpigmentation, lipodermatosclerosis, stasis dermatitis, or atrophie blanche
...
\begin{itemize}
  \item Leg pain, heaviness, aching, fatigue, edema, itching, restless legs, muscle cramps, burning sensation
\end{itemize}
\textbf{Note:} Varicose veins are a cosmetic concern for many, but the progressive nature of chronic venous insufficiency means symptoms typically worsen over time without intervention.
...
\begin{itemize}
  \item Clinical examination in standing position: assess distribution of varicosities, edema, skin changes, ulcers
  ...
  \item CEAP classification: clinical class (C0--C6), etiology (primary, secondary, congenital), anatomy (superficial, deep, perforator), pathophysiology (reflux, obstruction, both)
...
\begin{itemize}
  ...
  \item Venous stenting for iliac vein obstruction; wound care and compression for venous ulcers
\end{itemize}
