...
\begin{itemize}
  ...
  \item CEAP classification: clinical class (C0--C6), etiology (primary, secondary, congenital), anatomy (superficial, deep, perforator), pathophysiology (reflux, blockage, both)
